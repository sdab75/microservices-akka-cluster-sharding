...
public class DefEventListener extends UntypedActor {
    ...
    public DefEventListener() {
        ...
        mediator.tell(new DistributedPubSubMediator.Subscribe("defEventContent", "defEventGrp", getSelf()), getSelf());
...
//    ActorRef myEntitySupervisor = ClusterSharding.get(getContext().system()).shardRegion("DefEventStoreSupervisor");
    ActorRef myEntitySupervisor = ClusterSharding.get(getContext().system()).startProxy("DefEventStoreSupervisor",Optional.empty(),DefService.messageExtractor);



    public void onReceive(Object msg) {
        System.out.println("DefEventListener Received============>"+msg.toString());
